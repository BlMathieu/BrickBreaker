...
import fr.umontpellier.iut.brickbreaker.controller.ChronometerController;
import fr.umontpellier.iut.brickbreaker.controller.GameMenuController;
import fr.umontpellier.iut.brickbreaker.controller.LevelConstructorController;
import fr.umontpellier.iut.brickbreaker.controller.SoundGestionController;
...
import fr.umontpellier.iut.brickbreaker.model.Ball;
import fr.umontpellier.iut.brickbreaker.model.Brick;
import fr.umontpellier.iut.brickbreaker.model.Racket;
...
public class BrickBreakerController extends AnchorPane {
    ...
    private ArrayList<Brick> brickMemoryAdd; //prend en mémoire les bricks ajouter
    private ArrayList<Brick> brickMemoryRemove; //prend en mémoire les bricks supprimer
    ...
    private double racketSizeWidth = 200;
...
/** Lance le jeu, initialise la timeline et remet à 0 **/
    ...
    @FXML /** Executer quand le joueur clic sur le bouton pause, met en pause le jeu **/
