...
import fr.umontpellier.iut.brickbreaker.metier.entite.Score;
import fr.umontpellier.iut.brickbreaker.metier.manager.ScoreManager;
...
public class ViewPlayerLeaderBoard extends Pane {
    ...
    private void generateOnlyOther(){
        if(Session.getInstance().isConnected()){
            ...
            if(highScoreTetris!=null){ Calendar cal = getTime(highScoreTetris); scoreTETRIS = highScoreTetris.getGameCode() + " : " +highScoreTetris.getLogin()+ " ---> " + highScoreTetris.getScore() + " || " + + cal.get(Calendar.DAY_OF_MONTH) + " " + getMonth(cal) + " " + cal.get(Calendar.YEAR) + " " + cal.get(Calendar.HOUR_OF_DAY) + "H" + cal.get(Calendar.MINUTE) + " ||";}
            if(highScoreDK!=null){  Calendar cal = getTime(highScoreDK); scoreDK = highScoreDK.getGameCode() + " : " + highScoreDK.getLogin() + " ---> " + highScoreDK.getScore() + " || " + + cal.get(Calendar.DAY_OF_MONTH) + " " + getMonth(cal) + " " + cal.get(Calendar.YEAR) + " " + cal.get(Calendar.HOUR_OF_DAY) + "H" + cal.get(Calendar.MINUTE) + " ||";}
            if(highScoreTRON!=null){ Calendar cal = getTime(highScoreTRON);  scoreTRON = highScoreTRON.getGameCode() + " : " + highScoreTRON.getLogin() + " ---> " + highScoreTRON.getScore() + " || "  + + cal.get(Calendar.DAY_OF_MONTH) + " " + getMonth(cal) + " " + cal.get(Calendar.YEAR) + " " + cal.get(Calendar.HOUR_OF_DAY) + "H" + cal.get(Calendar.MINUTE) + " ||";}
