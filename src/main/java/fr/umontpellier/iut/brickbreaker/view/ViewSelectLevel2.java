...
public class ViewSelectLevel2 extends Pane {
    ...
    private void clickLevel4(MouseEvent event){
        ...
        else if(chooseLevel==true && brickBreakerController.getPickedLevel()=="4"){
    ...
    private void clickLevel5(MouseEvent event){
        ...
        else if(chooseLevel==true && brickBreakerController.getPickedLevel()=="5"){
    ...
    private void clickLevel6(MouseEvent event){
        ...
        else if(chooseLevel==true && brickBreakerController.getPickedLevel()=="6"){
