...
import fr.umontpellier.iut.brickbreaker.controller.GameDifficultyController;
...
public class ViewSelectLevel extends Pane {
    ...
    private GameDifficultyController gameDifficulty;
    ...
    private void clickLevel1(MouseEvent event){
        ...
        else if(chooseLevel==true && brickBreakerController.getPickedLevel()=="1"){
    ...
    private void clickLevel2(MouseEvent event){
        ...
        else if(chooseLevel==true && brickBreakerController.getPickedLevel()=="2"){
    ...
    private void clickLevel3(MouseEvent event){
        ...
        else if(chooseLevel==true && brickBreakerController.getPickedLevel()=="3"){
    ...
    private void clickT(){
        ...
        else if(chooseLevel==true && brickBreakerController.getPickedLevel()=="Aleatoire"){
