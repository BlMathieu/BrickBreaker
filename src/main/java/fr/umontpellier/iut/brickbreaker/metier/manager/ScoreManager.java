...
import fr.umontpellier.iut.brickbreaker.stockage.sql.StockageScoreDatabase;
...
public class ScoreManager {
    ...
    public Score getHighScoreByLogin(String login) { return stockage.getHighScore(login, "CB"); }

    public Score getScoreById(int id) {
        return stockage.getById(id);
    }

    public Score getHighScoreByGame(String login, String gameCode) { return stockage.getHighScore(login, gameCode); }
    ...
    public List<Score> getLeaderboard() { return stockage.getLeaderboard(); }

    public List<Score> getScoresByGame(String gameCode) { return stockage.getAllByGameCode(gameCode); }
}